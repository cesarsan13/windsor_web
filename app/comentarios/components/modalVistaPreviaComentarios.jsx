            ...
            <div className='modal-box w-full max-w-4xl h-full'>
                ...
                <div className='flex flex-row space-x-4'>
                    <Tooltip Titulo={"Imprimir PDF"} posicion={"tooltip-top"}>
                        <button className='bg-transparent over:bg-slate-200 dark:hover:bg-neutral-700 text-neutral-600 dark:text-white rounded-lg btn shadow-md' onClick={PDF}>Imprimir PDF<i className='fa-solid fa-file-pdf'></i></button>                        
                    </Tooltip>
