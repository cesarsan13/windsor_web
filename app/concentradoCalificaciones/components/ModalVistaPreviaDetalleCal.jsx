...
function ModalVistaPreviaDetalleCal({ pdfPreview, pdfData, PDF, Excel }) {
    ...
    return (
        <dialog id='modalVDetCal' className='modal'>
            <div className='modal-box w-full max-w-4xl h-full'>
                <button className='btn btn-sm btn-circle btn-ghost absolute right-2 top-2 dark:text-white text-black'
                    onClick={() => document.getElementById("modalVDetCal").close()}
                >
                    ✕
                </button>
                <h3 className='font-bold text-lg mb-5 dark:text-white text-black'>Vista Previa Detalles Calificaciones</h3>
...
export default ModalVistaPreviaDetalleCal