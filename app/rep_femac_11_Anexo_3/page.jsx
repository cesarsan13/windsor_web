...
function CobranzaPorAlumno() {
    ...
    return (
        <>
            ...
            <div className="container w-full overflow-x-auto  max-w-screen-xl bg-slate-100 dark:bg-slate-700 shadow-xl rounded-xl px-3">
                ...
                <div className="container grid grid-cols-8 grid-rows-1 h-[calc(100%-20%)]">
                    ...
                    <div className="col-span-7">
                        <div className="flex flex-col h-full space-y-4">
                            <div className="flex space-x-0 flex-col md:space-x-4 md:flex-row">
                                <Inputs
                                    name={"fecha_ini"}
                                    tamañolabel={""}
                            ...
                            <div className="flex flex-wrap space-x-0 space-y-1 md:space-y-2 lg:space-y-0 lg:space-x-4 ">
                                <BuscarCat
                                    table="alumnos"
                                    itemData={[]}
