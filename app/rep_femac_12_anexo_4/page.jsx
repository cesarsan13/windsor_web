...
function RepFemac12Anexo() {
    ...
    const handleVerClick = async () => {
        ...
        dataTrabRepCobr.forEach((trabRep) => {
            ...
            reporte.ImpPosX(trabRep.alumno.toString() + "-" + calculaDigitoBvba(trabRep.alumno.toString()), 14, reporte.tw_ren);
            ...
            <div className='container w-full  max-w-screen-xl bg-slate-100 dark:bg-slate-700 shadow-xl rounded-xl px-3'>
                ...
                <div className='container grid grid-cols-8 grid-rows-1 h-[calc(100%-20%)]'>
                    <div className='col-span-1 flex flex-col'>
                        <Acciones ImprimePDF={ImprimePDF} ImprimeExcel={ImprimeExcel} Ver={handleVerClick} home={home} />
                    </div>
