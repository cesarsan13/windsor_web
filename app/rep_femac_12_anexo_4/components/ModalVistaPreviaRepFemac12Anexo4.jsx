...
function ModalVistaPreviaRepFemac12Anexo4({ pdfPreview, pdfData, PDF, Excel }) {
    ...
    return (
        <dialog id='modalVPRepFemac12Anexo4' className='modal'>
            <div className='modal-box w-full max-w-4xl h-full'>
                <button className='btn btn-sm btn-circle btn-ghost absolute right-2 top-2 dark:text-white text-black'
                    onClick={() => document.getElementById("modalVPRepFemac12Anexo4").close()}
                >
                    ✕
                </button>
...
export default ModalVistaPreviaRepFemac12Anexo4
