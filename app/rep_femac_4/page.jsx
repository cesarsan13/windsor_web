...
import { calculaDigitoBvba,formatFecha,
    format_Fecha_String,} from "@/app/utils/globalfn";
...
function rep_femac_4() {
    ...
    const {
        ...
        defaultValues: {
            ...
            fecha_nac:formatFecha(credencial?.alumno?.fecha_nac || formatFecha(fecha_hoy)),
        },
      });
      useEffect(() => {
        reset({
          ...
          setTimeout(() => {
            ...
            formato.forEach((formato) => {
                switch (formato.descripcion_campo) {
                    case "No. Alumno":
                        reporte.ImpPosX(credencial.alumno.numero.toString(), (formato.columna_impresion*conX),(formato.renglon_impresion*conY), 0, "R");
                        break;
                    case "Ciclo escolar":
                        reporte.ImpPosX(credencial.alumno.ciclo_escolar.toString(), (formato.columna_impresion*conX),(formato.renglon_impresion*conY), 0, "L");
                        break;
                    case "Fecha nacimiento":
                        reporte.ImpPosX(credencial.alumno.fecha_nac.toString(), (formato.columna_impresion*conX),(formato.renglon_impresion*conY), 0, "L");
                        break;
                    case "Nombre":
                        reporte.ImpPosX(credencial.alumno.nombre.toString(), (formato.columna_impresion*conX),(formato.renglon_impresion*conY), 0, "L");
                        break;
                    case "Dirección":
                        reporte.ImpPosX(credencial.alumno.direccion.toString(), (formato.columna_impresion*conX),(formato.renglon_impresion*conY), 0, "L");
                        break;
                    case "Colonia":
                        reporte.ImpPosX(credencial.alumno.colonia.toString(), (formato.columna_impresion*conX),(formato.renglon_impresion*conY), 0, "L");
                        break;
                }
            });
            setTimeout(() => {
