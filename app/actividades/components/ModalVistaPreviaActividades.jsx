...
function ModalVistaPreviaActividades({ pdfPreview, pdfData, PDF, Excel }) {
  ...
  return (
    <dialog id="modalVPActividades" className='modal'>
      <div className='modal-box w-full max-w-4xl h-full'>
        <button
          ...
          onClick={() => document.getElementById("modalVPActividades").close()}
        >
          ✕
        </button>
...
export default ModalVistaPreviaActividades
