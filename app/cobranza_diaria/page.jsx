...
function Cobranza_Diaria() {
    ...
    const handleVerClick = async () => {
        ...
        cobranzaDiaria.forEach((cobranza) => {
            ...
            reporte.ImpPosX(cobranza.tipo_pago_1.toString(), 33, reporte.tw_ren, 0, "R")
            reporte.ImpPosX(formatNumber(cobranza.importe_pago_1.toString(), 2), 55, reporte.tw_ren, 0, "R")
            reporte.ImpPosX(cobranza.referencia_1.toString(), 58, reporte.tw_ren, 0, "L")
            reporte.ImpPosX(cobranza.tipo_pago_2.toString(), 113, reporte.tw_ren, 0, "R")
            reporte.ImpPosX(formatNumber(cobranza.importe_pago_2.toString(), 2), 128, reporte.tw_ren, 0, "R")
            reporte.ImpPosX(cobranza.referencia_2.toString(), 138, reporte.tw_ren, 0, "L")
            reporte.ImpPosX((cobranza?.cue_banco ? cobranza.cue_banco.toString() : ""), 213, reporte.tw_ren, 0, "R");
            reporte.ImpPosX(formatNumber(cobranza.importe.toString(), 2), 228, reporte.tw_ren, 0, "R")
            reporte.ImpPosX((cobranza?.referencia ? cobranza.referencia.toString() : ""), 238, reporte.tw_ren, 0, "L")
        ...
        reporte.ImpPosX(formatNumber(sumaTp1.toString(), 2), 55, reporte.tw_ren, 0, "R")
        reporte.ImpPosX(formatNumber(sumaTp2.toString(), 2), 128, reporte.tw_ren, 0, "R")
        reporte.ImpPosX(formatNumber(sumaTp3.toString(), 2), 228, reporte.tw_ren, 0, "R")
        reporte.nextRow(10)
        reporte.ImpPosX("Detalle de cobros", 14, reporte.tw_ren, 0, "L")
        reporte.nextRow(6)
        data.forEach((tp) => {
            const cobranza = cobranzaDiaria.filter(cobranza =>
            ...
            if (cobranza.length > 0) {
                ...
                reporte.ImpPosX(formatNumber(totalTipoPago.toString(), 2), 99, reporte.tw_ren, 0, "R")
                Enca1(reporte)
            }
        })
