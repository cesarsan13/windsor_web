...
function ModalVistaPreviaCobranzaDiaria({ pdfPreview, pdfData, PDF,Excel }) {
    return (
        <dialog id="modalVPCobranzaDiaria" className="modal">
...
export default ModalVistaPreviaCobranzaDiaria
