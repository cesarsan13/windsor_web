...
function ModalVistaPreviaProfesores({ pdfPreview, pdfData, PDF, Excel }) {
  ...
  return (
    <dialog id="modalVPProfesor" className="modal">
      <div className="modal-box w-full max-w-4xl h-full">
        <button
          ...
          onClick={() => document.getElementById("modalVPProfesor").close()}
        >
          ✕
        </button>
        <h3 className="font-bold text-lg mb-5 dark:text-white text-black">
          Vista Previa Profesores.
        </h3>
...
export default ModalVistaPreviaProfesores;
