...
function Profesores() {
    ...
    const handleVerClick = () => {
        ...
        body.forEach((profesores) => {
            ...
            reporte.ImpPosX(profesores.nombre_completo.toString(), 40, reporte.tw_ren, 0, "L");
            reporte.ImpPosX(profesores.direccion.toString(), 110, reporte.tw_ren, 0, "L");
            reporte.ImpPosX(profesores.colonia.toString(), 140, reporte.tw_ren, 0, "L");
            reporte.ImpPosX(profesores.ciudad.toString(), 170, reporte.tw_ren, 0, "L");
            reporte.ImpPosX(profesores.estado.toString(), 215, reporte.tw_ren, 0, "L");
            ...
            reporte.ImpPosX(profesores.telefono_1.toString(), 140, reporte.tw_ren, 12, "L");
            reporte.ImpPosX(profesores.telefono_2.toString(), 170, reporte.tw_ren, 12, "L");
            reporte.ImpPosX(profesores.celular.toString(), 200, reporte.tw_ren, 12, "L");
            Enca1(reporte);
    ...
    const onSubmitModal = handleSubmit(async (data) => {
        ...
        if (res.status) {
            ...
            showSwal(res.alert_title, res.alert_text, res.alert_icon); showModal(false);
