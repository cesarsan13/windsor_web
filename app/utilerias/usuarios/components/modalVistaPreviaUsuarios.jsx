...
function ModalVistaPreviaUsuarios({ pdfPreview, pdfData, PDF, Excel }) {
    ...
    <dialog id="modalVPUsuario" className="modal">
      <div className="modal-box w-full max-w-4xl h-full">
        <button
          ...
          onClick={() => document.getElementById("modalVPUsuario").close()}
        >
          ✕
        </button>
...
export default ModalVistaPreviaUsuarios;
