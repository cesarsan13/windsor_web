...
function ModalVistaPreviaAlumnos({ pdfPreview, pdfData, imprimePDF, ImprimeExcel }) {
            ...
            <div className='modal-box w-full max-w-4xl h-full'>
                ...
                <div className='flex flex-row space-x-4'>
                    <Tooltip Titulo={"Imprimir PDF"} posicion={"tooltip-top"}>
                        <button className='bg-blue-500 hover:bg-blue-700 text-white rounded-lg btn' onClick={imprimePDF}>Imprimir PDF<i className='fa-solid fa-file-pdf'></i></button>                        
                    </Tooltip>
                    <Tooltip Titulo={"Imprimir Excel"} posicion={"tooltip-top"}>
                    <button className='bg-blue-500 hover:bg-blue-700 text-white rounded-lg btn' onClick={ImprimeExcel}>Imprimir Excel<i className='fa-solid fa-file-excel'></i></button>                        
                    </Tooltip>
                </div>
                {pdfPreview && pdfData && (
