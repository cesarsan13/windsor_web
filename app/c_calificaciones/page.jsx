...
function C_Calificaciones() {
    ...
    const Buscar = handleSubmit(async (data) => {
        ...
        setisLoading2(true);
        const validacion = await validar(grupo.numero, materia, data.contraseña_profesor || '');
        if (!validacion) { setisLoading2(false); return }
    ...
    const handleVerClick = () => {
        ...
        body.forEach((calificacion) => {
            reporte.ImpPosX(calificacion.numero.toString(), 25, reporte.tw_ren, 0, "R");
            reporte.ImpPosX(calificacion.nombre.toString(), 30, reporte.tw_ren, 35, "L");
            reporte.ImpPosX(calificacion.unidad.toString(), 150, reporte.tw_ren, 35, "R");
            reporte.ImpPosX(calificacion.calificacion.toString(), 183, reporte.tw_ren, 35, "R");
            Enca1(reporte);
