...
import { useHorariosABC } from "./Hooks/useHorariosABC";
import { useHorariosPdfExcel } from "./Hooks/useHorariosPdfExcel";
...
function Horarios() {
  ...
  const { itemHeaderTable, itemDataTable, tableColumns, tableBody, modalBody } = 
    useHorariosUI(tableAction, register, permissions, isDisabled, errors);
  if (status === "loading") {
    return (
