...
function ModalVistaPreviaRepWBecas({ pdfPreview, pdfData, PDF, Excel }) {
    ...
    return (
        <dialog id='modalVPRepWBecas' className='modal'>
            <div className='modal-box w-full max-w-4xl h-full'>
                <button className='btn btn-sm btn-circle btn-ghost absolute right-2 top-2 dark:text-white text-black'
                    onClick={() => document.getElementById("modalVPRepWBecas").close()}
                >
                    ✕
                </button>
...
export default ModalVistaPreviaRepWBecas