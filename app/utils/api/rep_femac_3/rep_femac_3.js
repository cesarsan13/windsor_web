...
export const getAlumnosPorMes = async (token, horario, orden) => {
  horario =
    horario === undefined || Object.keys(horario).length === 0 ? "" : horario;
...
export const Imprimir = (configuracion) => {
  ...
  body.forEach((reporte) => {
    if (reporte.Nombre_1 === "") return;
    newPDF.ImpPosX(
      reporte.Num_Renglon.toString() !== "0"
        ? reporte.Num_Renglon.toString()
        : "",
      15,
      newPDF.tw_ren,
      0,
    ...
    newPDF.ImpPosX(
      reporte.Numero_1.toString() !== "0" ? reporte.Numero_1.toString() : "",
      25,
      newPDF.tw_ren,
      0,
      "R"
    ...
    newPDF.ImpPosX(
      reporte.Nombre_1.toString() !== "0" ? reporte.Nombre_1.toString() : "",
      35,
      newPDF.tw_ren,
      0,
      "L"
    ...
    newPDF.ImpPosX(
      reporte.Año_Nac_1.toString().substring(0, 4) !== "0"
        ? reporte.Año_Nac_1.toString().substring(0, 4)
        : "",
      130,
      newPDF.tw_ren,
      0,
