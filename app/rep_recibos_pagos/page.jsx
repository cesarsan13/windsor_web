    ...
    docsCobranzaFiltrados.forEach((item, index) => {
      if (alumnAnt !== item.alumno) {
        if (alumnAnt !== null) {
          ...
          newPDF.tw_ren = 260;
          newPDF.ImpPosX(
            `C A N T I D A D    A    P A G A R           ${formatNumber(
              saldo_total
            )}`,
            100,
            newPDF.tw_ren,
          ...
          newPDF.nextRow(5);
          newPDF.ImpPosX(
            `EL PAGO DEBERÁ HACERSE EN BBVA, S.A.   REFERENCIA...${ref}`,
            100,
            newPDF.tw_ren,
            0,
            "C"
          ...
          newPDF.nextRow(5);
          newPDF.ImpPosX(
            "UNICAMENTE PARA TRANSFERENCIAS ELECTRONICAS CLABE 012180004505271730",
            100,
            newPDF.tw_ren,
            0,
            "C"
          ...
          newPDF.nextRow(5);
          newPDF.ImpPosX(
            "PONER EN CONCEPTO NUMERO DE REFERENCIA",
            100,
            newPDF.tw_ren,
            0,
            "C"
          ...
          newPDF.nextRow(5);
          newPDF.ImpPosX(
            "FAVOR DE NO HACER CORRECCIONES      REALIZAR PAGO EXACTO",
            100,
            newPDF.tw_ren,
            0,
            "C"
      ...
      if (siImp && item.tw_saldo >= 0.09) {
        ...
        newPDF.ImpPosX(
          formatNumber(item.tw_saldo.toString()),
          190,
          newPDF.tw_ren,
          0,
          "R"
