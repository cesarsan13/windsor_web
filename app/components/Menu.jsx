...
function Menu({ vertical }) {
  const [isOpen, setIsOpen] = useState({ archivos: false, reportes: false, pagos: false });
  ...
  return vertical ? (
    ...
    >
      <li>
        <details open={isOpen.archivos} onClick={() => handleToggle("archivos")}>
      ...
      <li>
        <details open={isOpen.reportes} onClick={() => handleToggle("reportes")}>
    ...
    <ul ref={menuRef} className="menu menu-horizontal px-1 z-[2] text-black dark:text-white">
      <li>
        <details open={isOpen.archivos} onClick={() => handleToggle("archivos")}>
          <summary>Archivos</summary>
      ...
      <li>
        <details open={isOpen.reportes} onClick={() => handleToggle("reportes")}>
          ...
          <ul className="p-1 mt-3 w-60">
            ...
            <li><Link href="/rep_femac_8_anexo_1">Relacion de Recibos</Link></li>
          </ul>
        </details>
      </li>
      <li>
