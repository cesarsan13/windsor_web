            ...
            <div className='modal-box w-full max-w-4xl h-full'>
                ...
                <div className='flex flex-row space-x-4'>
                    <Tooltip Titulo={"Imprimir PDF"} posicion={"tooltip-top"}>
                        <button className='btn hover:bg-slate-200 dark:hover:bg-neutral-700' onClick={PDF}><i className='fa-solid fa-file-pdf'></i></button>
                    </Tooltip>
                    <Tooltip Titulo={"Imprimir Excel"} posicion={"tooltip-top"}>
                        <button className='btn hover:bg-slate-200 dark:hover:bg-neutral-700' onClick={Excel}><i className='fa-solid fa-file-excel'></i></button>
                    </Tooltip>
                </div>
                {pdfPreview && pdfData && (
