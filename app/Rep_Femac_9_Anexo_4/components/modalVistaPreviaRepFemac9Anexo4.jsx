...
function ModalVistaPreviaRepFemac9Anexo4({ pdfPreview, pdfData, PDF, Excel }) {
    ...
    return (
        <dialog id='modalVPRepFemac9Anexo4' className='modal'>
            <div className='modal-box w-full max-w-4xl h-full'>
                <button className='btn btn-sm btn-circle btn-ghost absolute right-2 top-2 dark:text-white text-black'
                    onClick={() => document.getElementById("modalVPRepFemac9Anexo4").close()}
                >
                    ✕
                </button>
                <h3 className='font-bold text-lg mb-5 dark:text-white text-black'>Vista Previa Relación de Facturas</h3>
...
export default ModalVistaPreviaRepFemac9Anexo4