        ...
        <table className="table table-xs table-zebra w-full">
          <thead className="sticky top-0 bg-white dark:bg-[#1d232a] z-[2]">
            <tr>
              ...
              <ActionColumn description={"Ver"} />
              <ActionColumn description={"Editar"} />
            </tr>
          </thead>
          <tbody>
            {basesDeDatosFiltrados.map((item) => (
              <tr key={item.id} className="hover:cursor-pointer">
                ...
                <td className="w-[15%] hidden sm:table-cell"> {item.host} </td>
                <td className="w-[10%] hidden sm:table-cell"> {item.port} </td>
